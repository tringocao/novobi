...
class LunchController(WebsiteSale):
    ...
    def confirmproduct(self,**post):
        ...
        _logger.info("in confirmproductttttttttttttttttttttttttttttttttttttttttttttttttttttt")
        _logger.info(request.session['lunch_order_id'])

        return True

    @http.route(['/receive_slack '], type='json', website=True, auth="public",methods=['POST'], csrf=False)
